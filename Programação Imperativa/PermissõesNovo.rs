...
impl Arquivo{
    ...
    fn stat(&self){
        ...
        println!("Permissões: {}(Usuário),{}(Grupo),{}(Outros)", self.permissoes.0.octal(), self.permissoes.1.octal(), self.permissoes.2.octal());
        println!("Permissões: {}(Usuário),{}(Grupo),{}(Outros)", self.permissoes.0.rwx(), self.permissoes.1.rwx(), self.permissoes.2.rwx());
